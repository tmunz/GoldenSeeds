...
import { SvgGeneratorInput, ColorInput, ExpressionInput, NumberInput, SelectionInput, StringInput } from "../generatorInput";
...
export class EditorService {
  ...
  getInputFieldConfiguration(type: ParamDefinitionType,
    stageId: number, name: string, definition: ParamDefinition, state: StageState<any>) {
