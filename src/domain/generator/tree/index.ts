...
export class Tree implements SvgGenerator {
  ...
  definition = {
    ...
    depth: { initial: '13', type: 'number' as const, min: 0, max: MathUtils.fib(6), step: 1 },
    splitAngle: { initial: '25', type: 'number' as const, min: 0, max: 90, step: 1 },
    splitVariation: { initial: '0.0', type: 'number' as const, min: -1, max: 1, step: 0.05 },
    splitProbability: { initial: '0.9', type: 'number' as const, min: 0, max: 1, step: 0.05 },
    lengthConservation: { initial: '0.8', type: 'number' as const, min: 0, max: 1, step: 0.05 },
    lengthVariation: { initial: '1', type: 'number' as const, min: 0, max: 1, step: 0.05 },
